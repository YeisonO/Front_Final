function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://129.151.116.51:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function cargarDatosMachine(id) {
    $.ajax({
        dataType: 'JSON',
        url:"http://129.151.116.51:8080/api/Machine/"+id,
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://129.151.116.51:8080/api/Machine/save",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://129.151.116.51:8080/api/Machine/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.116.51:8080/api/Machine/update",
